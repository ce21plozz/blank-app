...
st.markdown("<h1 style= 'text-align: center;font-family: Copperplate, Papyrus;color:white'>Tempat Duduk Generator</h1>", unsafe_allow_html=True)
...
def seatgen(subclass):
    ...
    for i in range(4):
        ...
        <div style="text-align:center;max-width: 60%; margin: auto;">
            <span style= "text-align:center !important;background-color: white;border-radius:3px;padding:3px">{rows[rcount]}</span>
