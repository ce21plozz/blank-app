...
import random
st.markdown("<h1 style= 'text-align: center;font-family: Papyrus'>Tempat Duduk Generator</h1>", unsafe_allow_html=True)
st.markdown("<h4 style= 'text-align: center;font-family: "Trebuchet MS", Helvetica, sans-serif;'>khusus kelas 10 (semua subkelas 10 bisa :D)</h4>", unsafe_allow_html=True)
