...
st.markdown("<h1 style= 'text-align: center;font-family: Courier;color:white'>Tempat Duduk Generator</h1>", unsafe_allow_html=True)
st.markdown("<h4 style= 'text-align: center;font-family: Helvetica;color:white'>khusus kelas 10 (semua subkelas 10 bisa :D)</h4>", unsafe_allow_html=True)
