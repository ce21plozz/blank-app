...
st.markdown("""
        ...
        <br>
        <span style='color:lime;text-shadow:-2px -2px 0 blue;font-weight:bold'>1.) Gw yang namanya cuma satu kata</span> <span style='color:orange;text-shadow:-2px -2px 0 #994708;font-weight:bold'>(Pembuat Projek)</span>
        <br>
