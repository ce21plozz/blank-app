...
""", unsafe_allow_html=True)
    st.markdown("<hr style= 'height:2px;background-color:white';border-radius:20px;>",
                unsafe_allow_html=True)
    st.markdown("""
            <style>
            .stAlert {
...
.kelompok:active {{
    width: 240px;
    border: 6px solid #85ff8b;
    transition: all 0.1s ease;
}}
</style>
""", unsafe_allow_html=True)
#form stuff here (html)
st.markdown(f"""<div style="text-align:center;font-size:1.6rem;background-color:#4377ab;border-radius:8px;padding:10px;">
                <span style='color:white;margin:5px;text-shadow:-2px -2px 0 red;font-weight:bold'>⭐RATING⭐</span>
...
st.markdown(f"""
            ...
            >
              ...
              <label class="label galdeano-regular">
                ...
                <br>
                <textarea class='widget' name="feedback" rows="5" cols="42" placeholder="Tulis Feedbacknya disini" maxlength="250" required></textarea>
              </label>
              <br>
